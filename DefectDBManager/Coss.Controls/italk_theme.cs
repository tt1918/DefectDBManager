...
namespace Coss.Controls
{
    ...
    public class iTalk_Button_2 : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                case 0:
                    _G.FillPath(BackColorIndex == 1 ? InactiveGB2 : InactiveGB, Shape);
                    _G.DrawPath(P1, Shape);
                    if ((Image == null))
                    {
                        _G.DrawString(Text, Font, new SolidBrush(BackColorIndex == 1?ForeColor2:ForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                            LineAlignment = StringAlignment.Center
                        });
                    ...
                    break;
                case 1:
                    _G.FillPath(BackColorIndex == 1 ? PressedGB2 : PressedGB, Shape);
                    _G.DrawPath(P3, Shape);
                    if ((Image == null))
                    {
                        _G.DrawString(Text, Font, new SolidBrush(BackColorIndex == 1?ForeColor2:ForeColor), R1, new StringFormat
    ...
    public class iTalk_Button_3 : Control
    {
        ...
        private Image _ImageLeftPressed;
        private Image _ImageRightPressed;
        private Size _ImageLeftSize;
        private Size _ImageRightSize;
        private Size _ImageLeftPressedSize;
        private Size _ImageRightPressedSize;
        private StringAlignment _TextAlignment = StringAlignment.Center;

        #endregion
        #region Image Design

        private static PointF ImageLocation(bool Left, SizeF Area, SizeF ImageArea)
        {
            PointF MyPoint = default(PointF);
            if (Left)
            {
        ...
        public Image ImageLeft
        {
            ...
            set
            {
                if (value == null)
                {
                    _ImageLeftSize = Size.Empty;
                }
                else
                {
                    _ImageLeftSize = value.Size;
                }
        ...
        public Image ImageLeftPressed
        {
            get { return _ImageLeftPressed; }
            set
            {
                if (value == null)
                {
                    _ImageLeftPressedSize = Size.Empty;
                }
                else
                {
                    _ImageLeftPressedSize = value.Size;
                }

                _ImageLeftPressed = value;
                Invalidate();
            }
        }
        ...
        public Image ImageRight
        {
            ...
            set
            {
                if (value == null)
                {
                    _ImageRightSize = Size.Empty;
                }
                else
                {
                    _ImageRightSize = value.Size;
                }
        ...
        public Image ImageRightPressed
        {
            get { return _ImageRightPressed; }
            set
            {
                if (value == null)
                {
                    _ImageRightPressedSize = Size.Empty;
                }
                else
                {
                    _ImageRightPressedSize = value.Size;
                }

                _ImageRightPressed = value;
                Invalidate();
            }
        }
        ...
        protected Size ImageLeftSize
        {
            get { return _ImageLeftSize; }
        }
        protected Size ImageRightSize
        {
            get { return _ImageRightSize; }
        }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            var leftL = new Rectangle(ClientRectangle.Left, ClientRectangle.Top, ClientRectangle.Width / 2, ClientRectangle.Height);
            var right = new Rectangle(ClientRectangle.Left + ClientRectangle.Width / 2, ClientRectangle.Top, ClientRectangle.Width / 2, ClientRectangle.Height);
            if(leftL.Contains(e.Location))
            {
                MouseState = 1;
            }
            else
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            PointF iptL = ImageLocation(true, Size, ImageLeftSize);
            PointF iptR = ImageLocation(false, Size, ImageRightSize);
            PointF iptLP = ImageLocation(true, Size, _ImageLeftPressedSize);
            PointF iptRP = ImageLocation(false, Size, _ImageRightPressedSize);
            ...
            switch (MouseState)
            {
                case 0:
                    ...
                    {
                        _G.DrawImage(_ImageLeft, iptL.X, iptL.Y, ImageLeftSize.Width, ImageLeftSize.Height);
                        _G.DrawImage(_ImageRight, iptR.X, iptR.Y, ImageRightSize.Width, ImageRightSize.Height);
                        _G.DrawString(Text, Font, new SolidBrush(ForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                            LineAlignment = StringAlignment.Center
                ...
                case 1:
                    _G.FillPath(PressedGB, Shape);
                    _G.DrawPath(P3, Shape);
                    if ((ImageLeft == null || ImageRight == null || ImageLeftPressed == null))
                    {
                        _G.DrawString(Text, Font, new SolidBrush(ForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                    ...
                    {
                        _G.DrawImage(_ImageLeftPressed, iptLP.X, iptLP.Y, _ImageLeftPressedSize.Width, _ImageLeftPressedSize.Height);
                        _G.DrawImage(_ImageRight, iptR.X, iptR.Y, ImageRightSize.Width, ImageRightSize.Height);
                        _G.DrawString(Text, Font, new SolidBrush(ForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                ...
                case 2:
                    _G.FillPath(PressedGB, Shape);
                    _G.DrawPath(P3, Shape);
                    if ((ImageLeft == null || ImageRight == null || ImageRightPressed == null))
                    {
                        _G.DrawString(Text, Font, new SolidBrush(ForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                    ...
                    {
                        _G.DrawImage(_ImageLeft, iptL.X, iptL.Y, ImageLeftSize.Width, ImageLeftSize.Height);
                        _G.DrawImage(_ImageRightPressed, iptRP.X, iptRP.Y, _ImageRightPressedSize.Width, _ImageRightPressedSize.Height);
                        _G.DrawString(Text, Font, new SolidBrush(ForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                            LineAlignment = StringAlignment.Center
