...
CDllTestDoc::CDllTestDoc() noexcept
{
...
void CDllTestDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CDllTestDoc::InitializeSearchContent()
{
...
void CDllTestDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
