...
{
    public partial class FormAiMonitorParam : Form
    {

        #region Param
        public string CultureCode="";
        public DefectDBManager.Preproc.AiMonitorParam Param
        {
            get { return _param; }
            set { _param = value; }
        }
        ...
        public FormAiMonitorParam()
        {
            ...
            _param = new DefectDBManager.Preproc.AiMonitorParam();
            _param.Load();

            UpdateLanguage(CultureCode);
        }

        private void FormAiMonitorParam_Load(object sender, EventArgs e)
        {
        ...
        private void FormAiMonitorParam_FormClosing(object sender, FormClosingEventArgs e)
        {
        }
        #endregion
        ...
        {
            DefectDBManager.Preproc.AiMonitorItem item = new DefectDBManager.Preproc.AiMonitorItem();
