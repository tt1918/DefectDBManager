...
#define FPGA_HOST_2_AVALON_SFID_SDRAM           0
#define FPGA_HOST_2_AVALON_SFID_SDRAM_SRAM      1

#define FPGA_DMA_READ_2_STREAM_FID              0xC010
#define FPGA_DMA_READ_2_STREAM_SFID_SDRAM       0
#define FPGA_DMA_READ_2_STREAM_SFID_SRAM        1

#define FPGA_STREAM_2_DMA_WRITE_FID             0xC011
#define FPGA_STREAM_2_DMA_WRITE_SFID_SDRAM      0
#define FPGA_STREAM_2_DMA_WRITE_SFID_SRAM       1
...
#define M_FPGA_OVERSCAN                         0x20000000L
#define M_DIRECT_ACCESS                         0x30000000L

#define M_FPGA_OVERSCAN_SHIFT_A                 16
#define M_FPGA_OVERSCAN_SHIFT_B                 0
#define M_FPGA_OVERSCAN_MASK                    0x0fff
#define M_OVERSCAN_OFFSET(A,B)                  (M_FPGA_OVERSCAN | ((A&M_FPGA_OVERSCAN_MASK)<<M_FPGA_OVERSCAN_SHIFT_A) | ((B&M_FPGA_OVERSCAN_MASK)<<M_FPGA_OVERSCAN_SHIFT_B))
