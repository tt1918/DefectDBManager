...
/////////////////////////////////////////////////////////////////////////////
// CFpspread_data 래퍼 클래스입니다.

class CFpspread_data : public CWnd
{
protected:
	DECLARE_DYNCREATE(CFpspread_data)
public:
...
//
	...
	LPDISPATCH RenderToMetafile()
	{
		LPDISPATCH result;
		InvokeHelper(0x234, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	void Refresh()
	{
