...
//COLOR
#define COLOR_GRAY31		( RGB(31,31,31) )
#define COLOR_GRAY51		( RGB(51,51,51) )
#define COLOR_GRAY191		( RGB(191, 191, 191) )
#define COLOR_GRAY127		( RGB(127, 127, 127) )
#define COLOR_GRAY227		( RGB(227, 227, 227) )
#define COLOR_GRAY237		( RGB(237, 237, 237) )
#define COLOR_GRAY242		( RGB(242, 242, 242) )
#define COLOR_WHITE			( RGB(255, 255, 255) )
#define COLOR_DGREEN		( RGB(56, 87, 35)	)
#define COLOR_BLACK			( RGB(0, 0, 0) )
#define COLOR_RED			( RGB(255, 0, 0) )
#define COLOR_BLUE			( RGB(46,117,182) )
#define COLOR_BLUE			( RGB(46,117,182) )
#define COLOR_YELLOW		( RGB(253,228,55) )
#define COLOR_GREEN			( RGB(0,255,0) )

#define  COLOR_BACK			( RGB(0,0,0) )
#define  COLOR_FOCUS		( RGB(229,241,251) )
...
public:
	DWORD		m_TextAlign;
	CFont*		m_UserFont;
	void		SetUserFont(CFont* _userFont) { m_UserFont = _userFont; }

	void  SetCheckButton(BOOL _enable = FALSE) { m_bIsCheckBox = _enable; }
	...
	void  SetTextAlign(DWORD alignType) { m_TextAlign = alignType; }
