...
#define M_USER_NAME_MAX_SIZE                          1056L
...
// CXP MsysInquire
#define M_CONNECTION_COUNT                            2999L
#define M_CONNECTION_STATE                            3000L
/* Reserve next 15 values                       from  3001*/
/*                                             to     3015*/
#define M_CONNECTION_BIT_RATE_UP_DIRECTION            3016L
/* Reserve next 15 values                       from  3017*/
/*                                             to     3031*/
#define M_CONNECTION_BIT_RATE_DOWN_DIRECTION          3032L
/* Reserve next 15 values                       from  3033*/
/*                                             to     3047*/
#define M_CONNECTION_ID                               3048L
/* Reserve next 15 values                       from  3049*/
/*                                             to     3063*/
...
#define M_DIGITIZER_GET_INDEX(X)                      ((((X >> 16) & 0xFF) - 1))
...
#define M_STRICTLY_ROLE_BITS                          (M_ROLE_UNUSED_1 | M_ROLE_UNUSED_2 | M_ROLE_UNUSED_3 | M_SKIP_PORTABLE_CHECK | M_NO_DMIL_COMPENSATION | M_IS_RETURN_VALUE | M_ALLOW_PSEUDO_ID |M_IN|M_OUT|M_ALLOW_NULL_ID|M_ALLOW_DEFAULT_ID|M_AS_VALUE|M_ALLOW_BUFFER_WITH_REGION)
...
#define M_CLASS_PRETRAINED_CONTEXT                    (M_CLASS_OBJECT         | 0x00000002L )
#define M_CLASS_RESULT                                (M_CLASS_OBJECT         | 0x00000020L )
...
#define M_IN_SYS_INQUIRE_STRING_RANGE(X)                 ((((X&~M_CLIENT_TEXT_ENCODING) >= M_SYS_INQUIRE_STRING_START) &&     \
                                                           ((X&~M_CLIENT_TEXT_ENCODING) <= M_SYS_INQUIRE_STRING_END  )   ) || \
